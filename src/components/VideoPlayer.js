...
const VideoPlayer = ({ src, isOpen, onClose }) => {
        ...
        <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center bg-black bg-opacity-50 z-50">
          <div className="bg-white p-4 rounded-lg relative">
            ...
            <div className="w-96 h-72 mx-auto">
              ...
              {!isPlaying && (
                <button
                  className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-gray-900 text-white px-4 py-2 rounded-md animate-bounce"
                  onClick={togglePlay}
                >
                  Play
                </button>
